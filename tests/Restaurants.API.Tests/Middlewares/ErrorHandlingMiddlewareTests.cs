...
public class ErrorHandlingMiddlewareTests
{
    ...
    [Fact()]
    public async Task InvokeAsync_WhenNotFoundExceptionThrown_ShoulSetStatusCode404AndWriteExceptionMessage()
    {
        // arrange
    ...
    [Fact()]
    public async Task InvokeAsync_WhenForbidExceptionThrown_ShoulSetStatusCode403()
    {
        // arrange
    ...
    [Fact()]
    public async Task InvokeAsync_WhenGenericExceptionThrown_ShoulSetStatusCode500()
    {
        // arrange
